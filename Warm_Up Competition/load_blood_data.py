...
def load_blood_data(train=True, SEED=97, scale  = False, 
    ...
    file_name = 'training-data.csv' if train else 'testing-data.csv'
...
X_test, IDs = load_blood_data(train=False, SEED   = SEED, scale  = scale, minmax = minmax,norm   = norm,nointercept = nointercept, engineering = engineering)
X_test.head()
